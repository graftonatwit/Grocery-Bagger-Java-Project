...
/**
 * Enumeration of grocery item firmness for the GroceryBagger application. There are no values
 * associated with firmness, instead, the order of instances conveys softer -> firmer
 *
...
public enum GroceryItemFirmness
    ...
    // NOTE item firmness must be defined from softest to hardest
